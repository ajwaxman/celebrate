...
open class B68UIFloatLabelTextField: UITextField {
    ...
    fileprivate func setupObservers() {
        ...
        NotificationCenter.default.addObserver(self, selector:Selector("fontSizeDidChange:"), name: NSNotification.Name.UIContentSizeCategoryDidChange, object: nil)
    ...
    fileprivate func setupViewDefaults() {
        ...
        verticalPadding = 0.8 * self.frame.height
